def test_cellpose_imports_without_error():
    import cellpose3_legacy
    from cellpose3_legacy import models, core
    model = models.CellposeModel()


def test_model_zoo_imports_without_error():
    from cellpose3_legacy import models, denoise
...
def test_gui_imports_without_error():
    from cellpose3_legacy import gui


def test_gpu_check():
    #     from cellpose3_legacy import models
    #     models.use_gpu()
    from cellpose3_legacy import core
    core.use_gpu()
